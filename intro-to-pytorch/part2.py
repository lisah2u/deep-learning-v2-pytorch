...
# In PyTorch, the - 1 tells the reshape() function 
# to figure out what the value should be based on 
# the number of elements contained within the tensor.
# test = images.view(images.shape[0],784)
out = images.view(images.shape[0], 10)
